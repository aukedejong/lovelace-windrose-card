...
export class SpeedUnits {
    ...
    static speedRangesMph = [
        ...
        new SpeedRange(8, 60, 70),
        new SpeedRange(9, 70, -1),
    ];
    static speedRangesKph = [
        new SpeedRange(0, 0, 10),
        new SpeedRange(1, 10, 20),
        new SpeedRange(2, 20, 30),
        new SpeedRange(3, 30, 40),
        new SpeedRange(4, 40, 50),
        new SpeedRange(5, 50, 60),
        new SpeedRange(6, 60, 70),
